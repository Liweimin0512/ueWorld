...
FRPGGameplayEffectContainerSpec UGameplayAbilityBase::MakeEffectContainerSpecFromContainer(const FRPGGameplayEffectContainer& Container, 
	const FGameplayEventData& EventData, int32 OverrideGameplayLevel)
{
	// First figure out our actor info
	FRPGGameplayEffectContainerSpec ReturnSpec;
	AActor* OwningActor = GetOwningActorFromActorInfo();
	AunWorldCharacter* OwningCharacter = Cast<AunWorldCharacter>(OwningActor);
...
TArray<FActiveGameplayEffectHandle> UGameplayAbilityBase::ApplyEffectContainerSpec(const FRPGGameplayEffectContainerSpec& ContainerSpec)
{
